...
def test_time_coupled_rao():
    ...
    check_costs(results_df, "202511040230", total_cost=155010.0, functional_cost=145010.0, rd_set_point=2900.0)
    check_costs(results_df, "202511040330", total_cost=250009.999, functional_cost=50010.0, rd_set_point=1000.0)
    ...
    check_costs(results_df, "202511040930", total_cost=60009.999, functional_cost=50010.0, rd_set_point=1000.0)
    ...
    check_costs(results_df, "202511041430", total_cost=60009.999, functional_cost=50010.0, rd_set_point=1000.0)
    ...
    check_costs(results_df, "202511042030", total_cost=250009.999, functional_cost=50010.0, rd_set_point=1000.0)
    check_costs(results_df, "202511042130", total_cost=155010.0, functional_cost=145010.0, rd_set_point=2900.0)
