...
public final class RaoCFunctions {
    ...
    private static Map<String, String> getExtensionData(PyPowsyblApiHeader.RaoParametersPointer parameterPointer) {
        return CTypeUtil.toStringMap(parameterPointer.getProviderParametersKeys(),
            parameterPointer.getProviderParametersKeysCount(),
            parameterPointer.getProviderParametersValues(),
            parameterPointer.getProviderParametersValuesCount());
    }
    ...
    private static void convertExtensionData(RaoParameters parameters, PyPowsyblApiHeader.RaoParametersPointer parameterPointer) {
        ...
        parameterPointer.setProviderParametersKeys(Util.getStringListAsPtr(keys));
        parameterPointer.setProviderParametersKeysCount(keys.size());
        parameterPointer.setProviderParametersValues(Util.getStringListAsPtr(values));
        parameterPointer.setProviderParametersValuesCount(values.size());
    }
}
