...
public final class NetworkElementAdders {
    ...
    private static final Map<DataframeElementType, NetworkElementAdder> ADDERS = Map.ofEntries(
            ...
            Map.entry(LOADING_LIMITS, new LoadingLimitsDataframeAdder()),
            Map.entry(VOLTAGE_ANGLE_LIMITS, new VoltageAngleLimitsDataframeAdder()),
            ...
            Map.entry(OVERLOAD_MANAGEMENT_SYSTEM, new OverloadManagementSystemDataframeAdder())
    );
