...
public final class NetworkDataframes {
    ...
    static NetworkDataframeMapper twoWindingTransformers() {
        return NetworkDataframeMapperBuilder.ofStream(Network::getTwoWindingsTransformerStream, getOrThrow(Network::getTwoWindingsTransformer, "Two windings transformer"))
                ...
                .doubles("g_at_current_tap", (twt, context) -> perUnitBG(context, twt, NetworkDataframes.computeG(twt)), false)
                .doubles("b_at_current_tap", (twt, context) -> perUnitBG(context, twt, NetworkDataframes.computeB(twt)), false)
                .addProperties()
                .build();
    }
    ...
    static NetworkDataframeMapper threeWindingTransformers() {
        return NetworkDataframeMapperBuilder.ofStream(Network::getThreeWindingsTransformerStream, getOrThrow(Network::getThreeWindingsTransformer, "Three windings transformer"))
                ...
                .doubles("g1_at_current_tap", (twt, context) -> perUnitBG(context, NetworkDataframes.computeG(twt, ThreeSides.ONE), twt), false)
                .doubles("b1_at_current_tap", (twt, context) -> perUnitBG(context, NetworkDataframes.computeB(twt, ThreeSides.ONE), twt), false)
                ...
                .doubles("g2_at_current_tap", (twt, context) -> perUnitBG(context, NetworkDataframes.computeG(twt, ThreeSides.TWO), twt), false)
                .doubles("b2_at_current_tap", (twt, context) -> perUnitBG(context, NetworkDataframes.computeB(twt, ThreeSides.TWO), twt), false)
                ...
                .doubles("g3_at_current_tap", (twt, context) -> perUnitBG(context, NetworkDataframes.computeG(twt, ThreeSides.THREE), twt), false)
                .doubles("b3_at_current_tap", (twt, context) -> perUnitBG(context, NetworkDataframes.computeB(twt, ThreeSides.THREE), twt), false)
                .booleans("fictitious", Identifiable::isFictitious, Identifiable::setFictitious, false)
                .addProperties()
                .build();
    }
