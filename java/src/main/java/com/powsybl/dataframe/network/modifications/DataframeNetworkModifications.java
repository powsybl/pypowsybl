 ...
 */
public final class DataframeNetworkModifications {

    private DataframeNetworkModifications() {
    }

    private static final Map<DataframeNetworkModificationType, DataframeNetworkModification> MODIFICATION = Map
            .ofEntries(
    ...
    public static DataframeNetworkModification getModification(DataframeNetworkModificationType type) {
        return MODIFICATION.get(type);
    }

    public static void applyModification(DataframeNetworkModificationType type, Network network,
            List<UpdatingDataframe> dataframe, boolean throwException, ReporterModel reporter) {
        DataframeNetworkModification modification = MODIFICATION.get(type);
