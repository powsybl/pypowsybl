...
public class IdentifiableShortCircuitDataframeProvider extends AbstractSingleDataframeNetworkExtension implements NetworkExtensionDataframeProvider {
    @Override
    ...
    private IdentifiableShortCircuit getOrThrow(Network network, String id) {
        ...
        IdentifiableShortCircuit isc = (IdentifiableShortCircuit) identifiable.getExtension(IdentifiableShortCircuit.class);
        if (isc == null) {
