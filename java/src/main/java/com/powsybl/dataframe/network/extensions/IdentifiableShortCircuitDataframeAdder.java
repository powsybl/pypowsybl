...
public class IdentifiableShortCircuitDataframeAdder extends AbstractSimpleAdder {
    ...
    private static class IdentifiableShortCircuitSeries {
        ...
        void create(Network network, int row) {
            ...
            IdentifiableShortCircuitAdder adder = (IdentifiableShortCircuitAdder) identifiable.newExtension(IdentifiableShortCircuitAdder.class);
    ...
    public void addElements(Network network, UpdatingDataframe dataframe) {
        IdentifiableShortCircuitDataframeAdder.IdentifiableShortCircuitSeries series = new IdentifiableShortCircuitDataframeAdder.IdentifiableShortCircuitSeries(dataframe);
