...
import static com.powsybl.dataframe.DataframeNetworkModificationType.*;
...
public final class NetworkModifications {
    ...
    public static void applyModification(DataframeNetworkModificationType type, Network network, List<UpdatingDataframe> dataframes, boolean throwException, ReporterModel reporter) {
        ...
        modification.applyModification(network, dataframes, throwException, reporter);
    }
