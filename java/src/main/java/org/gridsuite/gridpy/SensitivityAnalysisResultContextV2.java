...
public class SensitivityAnalysisResultContextV2 implements SensitivityAnalysisResultContext {
    ...
    @Override
    public GridPyApiHeader.MatrixPointer createSensitivityMatrix(String contingencyId) {
        ...
        if (values != null) {
            ...
            GridPyApiHeader.MatrixPointer matrixPtr = UnmanagedMemory.calloc(SizeOf.get(GridPyApiHeader.MatrixPointer.class));
    ...
    @Override
    public GridPyApiHeader.MatrixPointer createReferenceFlows(String contingencyId) {
