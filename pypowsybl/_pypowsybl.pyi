...
class BranchSelectionStrategy:
    __members__: ClassVar[Dict[str, BranchSelectionStrategy]] = ...  # read-only
    ONLY_INTERCONNECTIONS: ClassVar[BranchSelectionStrategy] = ...
    ZONE_TO_ZONE_PTDF_CRITERIA: ClassVar[BranchSelectionStrategy] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
...
class ContingencyStrategy:
    __members__: ClassVar[Dict[str, ContingencyStrategy]] = ...  # read-only
    ONLY_N_STATE: ClassVar[ContingencyStrategy] = ...
    AUTO_CONTINGENCY: ClassVar[ContingencyStrategy] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
...
class FlowDecompositionParameters:
    ...
    branch_selection_strategy: BranchSelectionStrategy
...
def run_security_analysis(security_analysis_context: JavaHandle, network: JavaHandle, parameters: LoadFlowParameters, provider: str, dc: bool, report: Optional[JavaHandle]) -> JavaHandle: ...
def run_sensitivity_analysis(sensitivity_analysis_context: JavaHandle, network: JavaHandle, dc: bool, parameters: LoadFlowParameters, provider: str, report: Optional[JavaHandle]) -> JavaHandle: ...
...
def run_flow_decomposition(network: JavaHandle, parameters: FlowDecompositionParameters) -> SeriesArray: ...
