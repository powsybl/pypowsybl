...
from typing import ClassVar, Dict, Iterator, List, Sequence, Union, Any
...
def get_network_area_diagram_svg_and_metadata(network: JavaHandle, voltage_level_ids:  Union[str, List[str]], depth: int, high_nominal_voltage_bound: float, low_nominal_voltage_bound: float, nad_parameters: NadParameters, fixed_positions: Dataframe | None, branch_labels: Dataframe | None, three_wt_labels: Dataframe | None, injections_labels: Dataframe | None, bus_descriptions: Dataframe | None, vl_descriptions: Dataframe | None, bus_node_styles: Dataframe | None, edge_styles: Dataframe | None, three_wt_styles: Dataframe | None) -> List[str]: ...
...
def write_network_area_diagram_svg(network: JavaHandle, svg_file: str, metadata_file: str, voltage_level_ids:  Union[str, List[str]], depth: int, high_nominal_voltage_bound: float, low_nominal_voltage_bound: float, nad_parameters: NadParameters, fixed_positions: Dataframe | None, branch_labels: Dataframe | None, three_wt_labels: Dataframe | None, injections_labels: Dataframe | None, bus_descriptions: Dataframe | None, vl_descriptions: Dataframe | None, bus_node_styles: Dataframe | None, edge_styles: Dataframe | None, three_wt_styles: Dataframe | None) -> None: ...
