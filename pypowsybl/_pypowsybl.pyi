...
def get_single_line_diagram_svg_and_metadata(network: JavaHandle, container_id: str, parameters: SldParameters, labels: Optional[Dataframe], feeders_info: Optional[Dataframe]) -> List[str]: ...
def get_matrix_multi_substation_single_line_diagram_svg_and_metadata(network: JavaHandle, matrix_ids: List[List[str]], parameters: SldParameters, labels: Optional[Dataframe], feeders_info: Optional[Dataframe]) -> List[str]: ...
...
def write_single_line_diagram_svg(network: JavaHandle, container_id: str, svg_file: str, metadata_file: str, parameters: SldParameters, labels: Optional[Dataframe], feeders_info: Optional[Dataframe]) -> None: ...
def write_matrix_multi_substation_single_line_diagram_svg(network: JavaHandle, matrix_ids: List[List[str]], svg_file: str, metadata_file: str, parameters: SldParameters, labels: Optional[Dataframe], feeders_info: Optional[Dataframe]) -> None: ...
