...
def add_limit_reductions(security_analysis_context: JavaHandle, dataframe: Dataframe | None) -> None: ...
...
def create_element(network: JavaHandle, dataframes: list[Dataframe | None], element_type: ElementType) -> None: ...
...
def create_network_elements_series_array(network: JavaHandle, element_type: ElementType, filter_attributes_type: FilterAttributesType, attributes: list[str], array: Dataframe | None, per_unit: bool, nominal_apparent_power: float) -> SeriesArray: ...
...
def save_network(network: JavaHandle, file: str, format: str, parameters: dict[str,str], report: JavaHandle | None) -> None: ...
def save_network_to_string(network: JavaHandle, format: str, parameters: dict[str,str], report: JavaHandle | None) -> str: ...
def save_network_to_binary_buffer(network: JavaHandle, format: str, parameters: dict[str,str], report: JavaHandle | None) -> bytes: ...
...
def get_network_area_diagram_svg(network: JavaHandle, voltage_level_ids:  str | list[str], depth: int, high_nominal_voltage_bound: float, low_nominal_voltage_bound: float, nad_parameters: NadParameters) -> str: ...
def get_network_area_diagram_svg_and_metadata(network: JavaHandle, voltage_level_ids:  str | list[str], depth: int, high_nominal_voltage_bound: float, low_nominal_voltage_bound: float, nad_parameters: NadParameters, fixed_positions: Dataframe | None, branch_labels: Dataframe | None, three_wt_labels: Dataframe | None, injections_labels: Dataframe | None, bus_descriptions: Dataframe | None, vl_descriptions: Dataframe | None, bus_node_styles: Dataframe | None, edge_styles: Dataframe | None, three_wt_styles: Dataframe | None) -> list[str]: ...
def get_network_area_diagram_displayed_voltage_levels(network: JavaHandle, voltage_level_ids:  str | list[str], depth: int) -> list[str]: ...
...
def get_single_line_diagram_svg_and_metadata(network: JavaHandle, container_id: str, parameters: SldParameters, labels: Dataframe | None, feeders_info: Dataframe | None, styles: Dataframe | None) -> list[str]: ...
def get_matrix_multi_substation_single_line_diagram_svg_and_metadata(network: JavaHandle, matrix_ids: list[list[str]], parameters: SldParameters, labels: Dataframe | None, feeders_info: Dataframe | None, styles: Dataframe | None) -> list[str]: ...
...
def load_network(file: str, parameters: dict[str,str], post_processors: list[str], report: JavaHandle | None, allow_variant_multi_thread_access: bool) -> JavaHandle: ...
def load_network_from_string(file_name: str, file_content: str, parameters: dict[str,str], post_processors: list[str], report: JavaHandle | None, allow_variant_multi_thread_access: bool) -> JavaHandle: ...
def load_network_from_binary_buffers(file_content: list[memoryview], parameters: dict[str,str], post_processors: list[str], report: JavaHandle | None, allow_variant_multi_thread_access: bool) -> JavaHandle: ...
def update_network(network: JavaHandle, file: str, parameters: dict[str,str], post_processors: list[str], report: JavaHandle | None) -> None: ...
def update_network_from_binary_buffers(network: JavaHandle, file_content: list[memoryview], parameters: dict[str,str], post_processors: list[str], report: JavaHandle | None) -> None: ...
...
def run_loadflow(network: JavaHandle, dc: bool, parameters: LoadFlowParameters, provider: str, report: JavaHandle | None) -> LoadFlowComponentResultArray: ...
def run_loadflow_async(network: JavaHandle, variant_id: str, dc: bool, parameters: LoadFlowParameters, provider: str, report: JavaHandle | None, results_future: Any) -> None: ...
...
def run_security_analysis(security_analysis_context: JavaHandle, network: JavaHandle, parameters: SecurityAnalysisParameters, provider: str, dc: bool, report: JavaHandle | None) -> JavaHandle: ...
def run_sensitivity_analysis(sensitivity_analysis_context: JavaHandle, network: JavaHandle, dc: bool, parameters: SensitivityAnalysisParameters, provider: str, report: JavaHandle | None) -> JavaHandle: ...
...
def write_network_area_diagram_svg(network: JavaHandle, svg_file: str, metadata_file: str, voltage_level_ids: str | list[str], depth: int, high_nominal_voltage_bound: float, low_nominal_voltage_bound: float, nad_parameters: NadParameters, fixed_positions: Dataframe | None, branch_labels: Dataframe | None, three_wt_labels: Dataframe | None, injections_labels: Dataframe | None, bus_descriptions: Dataframe | None, vl_descriptions: Dataframe | None, bus_node_styles: Dataframe | None, edge_styles: Dataframe | None, three_wt_styles: Dataframe | None) -> None: ...
def write_single_line_diagram_svg(network: JavaHandle, container_id: str, svg_file: str, metadata_file: str, parameters: SldParameters, labels: Dataframe | None, feeders_info: Dataframe | None, styles: Dataframe | None) -> None: ...
def write_matrix_multi_substation_single_line_diagram_svg(network: JavaHandle, matrix_ids: list[list[str]], svg_file: str, metadata_file: str, parameters: SldParameters, labels: Dataframe | None, feeders_info: Dataframe | None, styles: Dataframe | None) -> None: ...
...
def create_extensions(network: JavaHandle, dataframes: list[Dataframe | None], name: str) -> None: ...
...
def run_dynamic_simulation(dynamic_model: JavaHandle, network: JavaHandle, dynamic_mapping: JavaHandle, event_mapping: JavaHandle | None, timeseries_mapping: JavaHandle | None, parameters: DynamicSimulationParameters, report_node: JavaHandle | None) -> JavaHandle: ...
def add_all_dynamic_mappings(dynamic_mapping_handle: JavaHandle, category_name: str, dataframes: list[Dataframe | None]) -> None: ...
...
def remove_elements_modification(network: JavaHandle, connectable_ids: list[str], dataframe: Dataframe | None, remove_modification_type: RemoveModificationType, raise_exception: bool | None, report_node: JavaHandle | None) -> None: ...
...
def create_network_modification(network: JavaHandle, dataframes: list[Dataframe | None], network_modification_type: NetworkModificationType, raise_exception: bool | None, report_node: JavaHandle | None) -> None: ...
def split_or_merge_transformers(network: JavaHandle, transformer_ids: list[str], merge: bool, report_node: JavaHandle | None) -> None: ...
def get_single_line_diagram_component_library_names() -> list[str]: ...
def set_faults(short_circuit_analysis: JavaHandle, dfs: Dataframe | None) -> None: ...
...
def run_shortcircuit_analysis(context: JavaHandle, network: JavaHandle, parameters: ShortCircuitAnalysisParameters, provider: str, report_node: JavaHandle | None) -> JavaHandle: ...
...
def run_grid2op_loadflow(backend: JavaHandle, dc: bool, parameters: LoadFlowParameters, report_node: JavaHandle | None) -> LoadFlowComponentResultArray: ...
