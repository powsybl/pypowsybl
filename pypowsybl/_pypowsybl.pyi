...
from pypowsybl.network.scalable.impl.scaling_parameters import ScalingParameters
...
def scale(network: JavaHandle, scalable: Scalable, scaling_parameters: ScalingParameters, asked: float) -> float: ...
