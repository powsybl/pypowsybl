...
def replace_tee_point_by_voltage_level_on_line(network: JavaHandle, tee_point_line1: str, tee_point_line2: str, tee_point_line_to_remove: str, bbs_or_bus_id: str, new_line1_id: str, new_line2_id: str, new_line1_name, new_line2_name) -> None: ...
