...
def run_rao(network: JavaHandle, rao_context: JavaHandle, parameters: RaoParameters) -> None: ...
def run_voltage_monitoring(network: JavaHandle, rao_context: JavaHandle, parameters: LoadFlowParameters, provider: str) -> None: ...
def run_angle_monitoring(network: JavaHandle, rao_context: JavaHandle, parameters: LoadFlowParameters, provider: str) -> None: ...
