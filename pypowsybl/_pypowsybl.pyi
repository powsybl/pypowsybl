...
def run_dynamic_simulation(dynamic_model: JavaHandle, network: JavaHandle, dynamic_mapping: JavaHandle, event_mapping: JavaHandle, timeseries_mapping: JavaHandle, parameters: DynamicSimulationParameters, report_node: Optional[JavaHandle]) -> JavaHandle: ...
