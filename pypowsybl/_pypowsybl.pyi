...
def load_network_from_string(format: str, content: str, parameters: Dict[str,str], report: Optional[JavaHandle]) -> JavaHandle: ...
...
def add_event_branch_disconnection(event_mapping_handle: JavaHandle, event_model_id: str, static_id: str, eventTime: float, disconnectOrigin: bool, disconnectExtremity: bool) -> None: ...
def add_event_set_point_boolean(event_mapping_handle: JavaHandle, event_model_id: str, static_id: str, eventTime: float, stateEvent: bool) -> None: ...
...
def create_network_modification(network: JavaHandle, dataframe: Optional[Dataframe], network_modification_type: NetworkModificationType, raise_exception: Optional[bool], reporter: Optional[JavaHandle]) -> None: ...