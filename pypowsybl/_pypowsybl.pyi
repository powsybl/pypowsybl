...
def add_phase_tap_changer_position_action(security_analysis_context: JavaHandle, action_id: str, transformer_id: str, is_relative: bool, tap_position: int) -> None: ...
def add_ratio_tap_changer_position_action(security_analysis_context: JavaHandle, action_id: str, transformer_id: str, is_relative: bool, tap_position: int) -> None: ...
...
def add_event_disconnection(event_mapping_handle: JavaHandle, static_id: str, event_time: float, disconnect_only: BranchSide) -> None: ...
