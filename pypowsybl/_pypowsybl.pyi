...
def write_multi_substation_single_line_diagram_svg(network: JavaHandle, container_ids: List[List[str]], svg_file: str, metadata_file: str, parameters: SldParameters) -> None: ...
