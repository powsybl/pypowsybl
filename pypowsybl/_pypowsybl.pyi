...
class ObjectiveFunctionType:
    ...
    MAX_MIN_MARGIN_IN_MEGAWATT: ClassVar[ObjectiveFunctionType] = ...
    MAX_MIN_MARGIN_IN_AMPERE: ClassVar[ObjectiveFunctionType] = ...
    MAX_MIN_RELATIVE_MARGIN_IN_MEGAWATT: ClassVar[ObjectiveFunctionType] = ...
    MAX_MIN_RELATIVE_MARGIN_IN_AMPERE: ClassVar[ObjectiveFunctionType] = ...
    MIN_COST_IN_MEGAWATT: ClassVar[ObjectiveFunctionType] = ...
    MIN_COST_IN_AMPERE: ClassVar[ObjectiveFunctionType] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
...
class RaoParameters:
    ...
    preventive_stop_criterion: PreventiveStopCriterion
    curative_stop_criterion: CurativeStopCriterion
    curative_min_obj_improvement: float
    forbid_cost_increase: bool
    optimize_curative_if_preventive_unsecure: bool
    solver: Solver
    relative_mip_gap: float
    solver_specific_parameters: str
    max_mip_iterations: int
    pst_penalty_cost: float
    pst_sensitivity_threshold: float
    pst_model: PstModel
    hvdc_penalty_cost: float
    hvdc_sensitivity_threshold: float
    injection_ra_penalty_cost: float
    ...
    contingency_scenarios_in_parallel: int
    preventive_leaves_in_parallel: int
    auto_leaves_in_parallel: int
    curative_leaves_in_parallel: int
