...
def create_glsk_importer(file: str) -> JavaHandle: ...
...
def get_glsk_injection_keys(importer: JavaHandle, country: str, timestamp: int) -> List[str]: ...
def get_glsk_factors(importer: JavaHandle, country: str, timestamp: int) -> List[float]: ...
