...
def run_rao(network_handle: JavaHandle, rao_handle: JavaHandle, crac_file: str, parameters_file: str, glsks_file: str) -> None: ...
def run_rao_from_buffers(network_handle: JavaHandle, rao_handle: JavaHandle, crac_buffer: memoryview, parameters_buffer: memoryview, glsks_buffer: memoryview) -> None: ...
def serialize_rao_results_to_file(rao_handle: JavaHandle, file_path: str) -> None: ...
def serialize_rao_results_to_buffer(rao_handle: JavaHandle) -> bytes: ...