...
CONVERGED: pypowsybl.loadflow.LoadFlowComponentStatus
CURRENT: LimitType
CURRENT_LIMITS: ElementType
DANGLING_LINE: ElementType
DC_VALUES: pypowsybl.loadflow.VoltageInitMode
DEFAULT_ATTRIBUTES: FilterAttributesType
FAILED: pypowsybl.loadflow.LoadFlowComponentStatus
...
MAIN: pypowsybl.loadflow.ConnectedComponentMode
MAX_ITERATION_REACHED: pypowsybl.loadflow.LoadFlowComponentStatus
...
PREVIOUS_VALUES: pypowsybl.loadflow.VoltageInitMode
PROPORTIONAL_TO_CONFORM_LOAD: pypowsybl.loadflow.BalanceType
PROPORTIONAL_TO_GENERATION_P: pypowsybl.loadflow.BalanceType
PROPORTIONAL_TO_GENERATION_P_MAX: pypowsybl.loadflow.BalanceType
PROPORTIONAL_TO_LOAD: pypowsybl.loadflow.BalanceType
...
SOLVER_FAILED: pypowsybl.loadflow.LoadFlowComponentStatus
...
UNIFORM_VALUES: pypowsybl.loadflow.VoltageInitMode
...
class BalanceType:
    ...
    PROPORTIONAL_TO_CONFORM_LOAD: ClassVar[pypowsybl.loadflow.BalanceType] = ...
    PROPORTIONAL_TO_GENERATION_P: ClassVar[pypowsybl.loadflow.BalanceType] = ...
    PROPORTIONAL_TO_GENERATION_P_MAX: ClassVar[pypowsybl.loadflow.BalanceType] = ...
    PROPORTIONAL_TO_LOAD: ClassVar[pypowsybl.loadflow.BalanceType] = ...
...
class ConnectedComponentMode:
    __doc__: ClassVar[str] = ...  # read-only
    __members__: ClassVar[dict] = ...  # read-only
    ALL: ClassVar[pypowsybl.loadflow.ConnectedComponentMode] = ...
    MAIN: ClassVar[pypowsybl.loadflow.ConnectedComponentMode] = ...
    __entries: ClassVar[dict] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
...
class LoadFlowComponentStatus:
    __doc__: ClassVar[str] = ...  # read-only
    __members__: ClassVar[dict] = ...  # read-only
    CONVERGED: ClassVar[pypowsybl.loadflow.LoadFlowComponentStatus] = ...
    FAILED: ClassVar[pypowsybl.loadflow.LoadFlowComponentStatus] = ...
    MAX_ITERATION_REACHED: ClassVar[pypowsybl.loadflow.LoadFlowComponentStatus] = ...
    SOLVER_FAILED: ClassVar[pypowsybl.loadflow.LoadFlowComponentStatus] = ...
    __entries: ClassVar[dict] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
...
class SeriesMetadata:
    def __init__(self, arg0: str, arg1: int, arg2: bool, arg3: bool) -> None: ...
    @property
...
class VoltageInitMode:
    __doc__: ClassVar[str] = ...  # read-only
    __members__: ClassVar[dict] = ...  # read-only
    DC_VALUES: ClassVar[pypowsybl.loadflow.VoltageInitMode] = ...
    PREVIOUS_VALUES: ClassVar[pypowsybl.loadflow.VoltageInitMode] = ...
    UNIFORM_VALUES: ClassVar[pypowsybl.loadflow.VoltageInitMode] = ...
    __entries: ClassVar[dict] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
...
def add_monitored_elements(security_analysis_context: JavaHandle, contingency_context_type: contingency_context_type, branch_ids: List[str], voltage_level_ids: List[str], three_windings_transformer_ids: List[str], contingency_ids: List[str]) -> None: ...
...
def create_element(network: JavaHandle, dataframes: List[Dataframe], elementType: ElementType) -> None: ...
...
def get_network_area_diagram_svg(network: JavaHandle, voltage_level_id: str, depth: int) -> str: ...
...
def update_network_elements_with_series(network: JavaHandle, dataframe: Dataframe, element_type: ElementType) -> None: ...
def update_switch_position(arg0: JavaHandle, arg1: str, arg2: bool) -> bool: ...
def write_network_area_diagram_svg(network: JavaHandle, svg_file: str, voltage_level_id: str, depth: int) -> None: ...
