...
def create_coupling_device(network: JavaHandle, df: Optional[Dataframe], raise_exception: Optional[bool], reporter: Optional[JavaHandle]) -> None: ...
def get_coupling_device_creation_metadata() -> List[SeriesMetadata]: ...
