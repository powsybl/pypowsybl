...
def replace_tee_point_by_voltage_level_on_line(network: JavaHandle, line1ZId: str, lineZ2Id: str, lineZPId: str, voltageLevelId: str, bbsOrBusId: str, line1CId: str, line1CName: str, lineC2Id: str, lineC2Name: str) -> None: ...
