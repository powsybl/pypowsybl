...
def get_network_area_diagram_svg_and_metadata(network: JavaHandle, voltage_level_ids:  Union[str, List[str]], depth: int, high_nominal_voltage_bound: float, low_nominal_voltage_bound: float, nad_parameters: NadParameters, fixed_positions: Optional[Dataframe], branch_labels: Optional[Dataframe]) -> List[str]: ...
...
def write_network_area_diagram_svg(network: JavaHandle, svg_file: str, metadata_file: str, voltage_level_ids:  Union[str, List[str]], depth: int, high_nominal_voltage_bound: float, low_nominal_voltage_bound: float, nad_parameters: NadParameters, fixed_positions: Optional[Dataframe], branch_labels: Optional[Dataframe]) -> None: ...
