...
def get_voltage_level_topology_creation_metadata() -> List[SeriesMetadata]: ...
def create_voltage_level_topology(network: JavaHandle, dataframe: Optional[Dataframe], switch_kind: List[str], raise_exception: Optional[bool], reporter: Optional[JavaHandle]) -> None: ...