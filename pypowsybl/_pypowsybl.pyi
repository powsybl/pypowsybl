...
def get_flow_cnec_results(rao_handle: JavaHandle, result_handle: JavaHandle) -> SeriesArray: ...
def get_angle_cnec_results(rao_handle: JavaHandle, result_handle: JavaHandle) -> SeriesArray: ...
def get_voltage_cnec_results(rao_handle: JavaHandle, result_handle: JavaHandle) -> SeriesArray: ...
def get_ra_results(rao_handle: JavaHandle, result_handle: JavaHandle) -> SeriesArray: ...
