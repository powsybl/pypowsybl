...
def run_loadflow_async(network: JavaHandle, dc: bool, parameters: LoadFlowParameters, provider: str, report: Optional[JavaHandle], results_future: LoadFlowResultsFutureWrapper) -> None: ...
