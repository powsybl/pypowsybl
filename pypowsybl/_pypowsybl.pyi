...
class OpenReacStatus:
    __members__: ClassVar[Dict[str, OpenReacStatus]] = ...  # read-only
    OK: ClassVar[OpenReacStatus] = ...
    NOT_OK: ClassVar[OpenReacStatus] = ...

class OpenReacObjective:
    __members__: ClassVar[Dict[str, OpenReacObjective]] = ...  # read-only
    MIN_GENERATION: ClassVar[OpenReacObjective] = ...
    BETWEEN_HIGH_AND_LOW_VOLTAGE_LIMIT: ClassVar[OpenReacObjective] = ...
    SPECIFIC_VOLTAGE_PROFILE: ClassVar[OpenReacObjective] = ...
...
def create_open_reac_params() -> JavaHandle: ...
def create_voltage_limit_override(min_voltage: float, max_voltage: float) -> JavaHandle: ...
def open_reac_add_variable_shunt_compensators(params_handle: JavaHandle, id_ptr: str) -> None: ...
def open_reac_add_constant_q_generators(params_handle: JavaHandle, id_ptr: str) -> None: ...
def open_reac_add_variable_two_windings_transformers(params_handle: JavaHandle, id_ptr: str) -> None: ...
def open_reac_add_specific_voltage_limits(id_ptr: str, min_voltage: float, params_handle: JavaHandle, max_voltage: float) -> None: ...
def open_reac_add_algorithm_param(params_handle: JavaHandle, key_ptr: str, value_ptr: str) -> None: ...
def open_reac_set_objective(params_handle: JavaHandle, objective: OpenReacObjective) -> None: ...
def open_reac_set_objective_distance(params_handle: JavaHandle, dist: float) -> None: ...
def run_open_reac(debug: bool, network_handle: JavaHandle, params_handle: JavaHandle) -> JavaHandle: ...
def open_reac_apply_all_modifications(result_handle: JavaHandle, network_handle: JavaHandle) -> None: ...
def open_reac_get_status(result_handle: JavaHandle) -> OpenReacStatus: ...
def open_reac_get_indicators(result_handle: JavaHandle) -> Dict[str, str]: ...
