...
def write_network_area_diagram_svg(network: JavaHandle, svg_file: str, metadata_file: str, voltage_level_ids:  Union[str, List[str]], depth: int, high_nominal_voltage_bound: float, low_nominal_voltage_bound: float, nad_parameters: NadParameters) -> None: ...
