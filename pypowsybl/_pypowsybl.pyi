...
class XnecSelectionStrategy:
    __members__: ClassVar[Dict[str, XnecSelectionStrategy]] = ...  # read-only
    ONLY_INTERCONNECTIONS: ClassVar[XnecSelectionStrategy] = ...
    INTERCONNECTION_OR_ZONE_TO_ZONE_PTDF_GT_5PC: ClassVar[XnecSelectionStrategy] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
...
def run_flow_decomposition(network: JavaHandle, flow_decomposition_parameters: FlowDecompositionParameters, load_flow_parameter: LoadFlowParameters) -> SeriesArray: ...
...
def add_alphabeta_load(dynamic_mapping_handle: JavaHandle, static_id: str, dynamic_param: str) -> None: ...
def add_one_transformer_load(dynamic_mapping_handle: JavaHandle, static_id: str, dynamic_param: str) -> None: ...
def add_omega_ref(dynamic_mapping_handle: JavaHandle, generator_id: str) -> None: ...
def add_generator_synchronous_three_windings(dynamic_mapping_handle: JavaHandle, static_id: str, dynamic_param: str) -> None: ...
def add_generator_synchronous_three_windings_proportional_regulations(dynamic_mapping_handle: JavaHandle, static_id: str, dynamic_param: str) -> None: ...
def add_generator_synchronous_four_windings(dynamic_mapping_handle: JavaHandle, static_id: str, dynamic_param: str) -> None: ...
def add_generator_synchronous_four_windings_proportional_regulations(dynamic_mapping_handle: JavaHandle, static_id: str, dynamic_param: str) -> None: ...
def add_current_limit_automaton(dynamic_mapping_handle: JavaHandle, static_id: str, dynamic_param: str, branch_side: str) -> None: ...
def add_curve(curve_mapping_handle: JavaHandle, dynamic_id: str, variable: str) -> None: ...
def add_event_quadripole_disconnection(event_mapping_handle: JavaHandle, event_model_id: str, static_id: str, parameter_set_id: str) -> None: ...
def add_event_set_point_boolean(event_mapping_handle: JavaHandle, event_model_id: str, static_id: str, parameter_set_id: str) -> None: ...
...
def get_all_dynamic_curves_ids(curve_mapping_handle: JavaHandle, dynamic_id: str) -> List[str]: ...
