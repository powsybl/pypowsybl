...
def get_unused_order_positions_before(network: JavaHandle, busbar_section_id: str) -> List[int]: ...
def get_unused_order_positions_after(network: JavaHandle, busbar_section_id: str) -> List[int]: ...
