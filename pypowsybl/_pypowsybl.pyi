...
class DistributionMode:
    __members__: ClassVar[Dict[str, DistributionMode]] = ...  # read-only
...
def scale_proportional(network: JavaHandle, asked: int, distribution_mode: DistributionMode, injections_ids: List[str], limit_min: int, limit_max: int, scaling_parameters: ScalingParameters) -> int : ...
...
def run_rao(network: JavaHandle, rao_context: JavaHandle, parameters: RaoParameters) -> JavaHandle: ...
def run_voltage_monitoring(network: JavaHandle, result_handle: JavaHandle, context_handle: JavaHandle, parameters: LoadFlowParameters, provider: str) -> JavaHandle: ...
def run_angle_monitoring(network: JavaHandle, result_handle: JavaHandle, context_handle: JavaHandle, parameters: LoadFlowParameters, provider: str) -> JavaHandle: ...
