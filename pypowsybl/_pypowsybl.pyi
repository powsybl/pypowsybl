...
class SensitivityVariableType:
    ...
    SHUNT_COMPENSATOR_SUSCEPTANCE: ClassVar[SensitivityVariableType] = ...
    BRANCH_RESISTANCE: ClassVar[SensitivityVariableType] = ...
    BRANCH_REACTANCE: ClassVar[SensitivityVariableType] = ...
    BRANCH_ADMITTANCE: ClassVar[SensitivityVariableType] = ...
    SVC_PILOT_POINT_TARGET_VOLTAGE: ClassVar[SensitivityVariableType] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
...
class PostContingencyResult:
    ...
    @property
    def disconnected_elements(self) -> List[str]: ...
    @property
...
class ElementType:
    ...
    BOUNDARY_LINE: ClassVar[ElementType] = ...
    BOUNDARY_LINE_GENERATION: ClassVar[ElementType] = ...
    ...
    LOADING_LIMITS: ClassVar[ElementType] = ...
    VOLTAGE_ANGLE_LIMITS: ClassVar[ElementType] = ...
    SELECTED_LOADING_LIMITS: ClassVar[ElementType] = ...
    ...
    DC_SWITCH: ClassVar[ElementType] = ...
...
class EdgeInfoType:
    ...
    NAME: ClassVar[EdgeInfoType] = ...
    VALUE_PERMANENT_LIMIT_PERCENTAGE: ClassVar[EdgeInfoType] = ...
    EMPTY: ClassVar[EdgeInfoType] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
...
class MarginCalculationParameters:
    start_time: float
    stop_time: float
    margin_calculation_start_time: float
    load_increase_start_time: float
    load_increase_stop_time: float
    contingencies_start_time: float
    calculation_type: int
    accuracy: int
    load_models_rule: int
    debug_dir: str
    provider_parameters_keys: List[str]
    provider_parameters_values: List[str]
    def __init__(self) -> None: ...
...
def get_switch_flows(network: JavaHandle, switch_ids: List[str]) -> SeriesArray: ...
...
def get_default_injections_labels_nad(network: JavaHandle) -> SeriesArray: ...
...
def set_network_name(network: JavaHandle, name: str) -> None: ...
def set_network_case_date(network: JavaHandle, case_date: float) -> None: ...
...
def update_network_from_binary_buffers(network: JavaHandle, file_content: List[memoryview], parameters: Dict[str,str], post_processors: List[str], report: Optional[JavaHandle]) -> None: ...
...
def flatten(network: JavaHandle) -> JavaHandle: ...
def reduce_network(network: JavaHandle, v_min: float, v_max: float, ids: List[str], vls: List[str], depths: List[int], with_boundary_lines: bool) -> None: ...
...
def check_loadflow_parameters(parameters: LoadFlowParameters, provider: str, report: Optional[JavaHandle]) -> bool: ...
def run_loadflow(network: JavaHandle, parameters: LoadFlowParameters, provider: str, report: Optional[JavaHandle]) -> LoadFlowComponentResultArray: ...
def run_loadflow_async(network: JavaHandle, variant_id: str, parameters: LoadFlowParameters, provider: str, report: Optional[JavaHandle], results_future: Any) -> None: ...
...
def run_security_analysis(security_analysis_context: JavaHandle, network: JavaHandle, parameters: SecurityAnalysisParameters, provider: str, report: Optional[JavaHandle]) -> JavaHandle: ...
def run_sensitivity_analysis(sensitivity_analysis_context: JavaHandle, network: JavaHandle, parameters: SensitivityAnalysisParameters, provider: str, report: Optional[JavaHandle]) -> JavaHandle: ...
...
def update_connectable_status(arg0: JavaHandle, arg1: str, arg2: bool, operate_disconnectors: bool, operate_fictitious: bool) -> bool: ...
...
def update_dc_switch_position(arg0: JavaHandle, arg1: str, arg2: bool) -> bool: ...
def validate(network: JavaHandle, report_node: Optional[JavaHandle]) -> ValidationLevel: ...
...
def create_report_node(task_key: str) -> JavaHandle: ...
...
def get_supported_models_information(category_name: str) -> SeriesArray: ...
def add_output_variables(output_variables_handle: JavaHandle, dynamic_id: str, variables: List[str], output_variable_type: OutputVariableType) -> None: ...
def get_events_information() -> SeriesArray: ...
def add_all_event_mappings(event_mapping_handle: JavaHandle, event_name: str, mapping_df: Dataframe) -> None: ...
def get_event_mappings_meta_data(event_name: str) -> List[SeriesMetadata]: ...
...
def create_dynamic_security_analysis() -> JavaHandle: ...
def add_dynamic_monitored_elements(dynamic_security_analysis_context: JavaHandle, contingency_context_type: ContingencyContextType, branch_ids: List[str], voltage_level_ids: List[str], three_windings_transformer_ids: List[str], contingency_ids: List[str]) -> None: ...
def run_dynamic_security_analysis(dynamic_security_analysis_context: JavaHandle, network: JavaHandle, dynamic_mapping: JavaHandle, event_mapping: Optional[JavaHandle], parameters: DynamicSecurityAnalysisParameters, provider: str, report_node: Optional[JavaHandle]) -> JavaHandle: ...
def create_margin_calculation() -> JavaHandle: ...
def create_loads_variation_mapping() -> JavaHandle: ...
def add_loads_variation(loads_variation_supplier: JavaHandle, load_ids: List[str], variation_value: float) -> None: ...
def run_margin_calculation(margin_calculation_context: JavaHandle, network: JavaHandle, dynamic_mapping: JavaHandle, loads_variation_supplier: JavaHandle, parameters: MarginCalculationParameters, report_node: Optional[JavaHandle]) -> JavaHandle: ...
def get_margin_calculation_load_increase_results(result_handle: JavaHandle) -> SeriesArray: ...
def get_margin_calculation_scenario_results(result_handle: JavaHandle) -> SeriesArray: ...
...
def create_scalable(type: int, injection_id: str, min_value: float, max_value: float, children: List[JavaHandle], percentages: List[float]) -> JavaHandle: ...
def scale(network: JavaHandle, scalable: JavaHandle, scaling_parameters: ScalingParameters, asked: float) -> float: ...
def compute_proportional_scalable_percentages(injection_ids: List[str], mode: DistributionMode, network: JavaHandle) -> List[float]: ...
...
def voltage_initializer_set_penalty_invest_rea_neg(
    params_handle: JavaHandle, penalty_invest_rea_neg: float) -> None: ...

def voltage_initializer_set_penalty_invest_rea_pos(
    params_handle: JavaHandle, penalty_invest_rea_pos: float) -> None: ...

def voltage_initializer_set_penalty_active_power(
    params_handle: JavaHandle, penalty_active_power: float) -> None: ...

def voltage_initializer_set_penalty_units_reactive(
    params_handle: JavaHandle, penalty_units_reactive: float) -> None: ...

def voltage_initializer_set_penalty_transfo_ratio(
    params_handle: JavaHandle, penalty_transfo_ratio: float) -> None: ...

def voltage_initializer_set_penalty_voltage_target_ratio(
    params_handle: JavaHandle, penalty_voltage_target_ratio: float) -> None: ...

def voltage_initializer_set_penalty_voltage_target_data(
    params_handle: JavaHandle, penalty_voltage_target_data: float) -> None: ...
...
def load_crac_source_with_parameters(network: JavaHandle, crac_source: memoryview, filename: str, parameters_source: memoryview) -> JavaHandle: ...
...
def get_global_cost_results(crac_handle: JavaHandle, result_handle: JavaHandle) -> SeriesArray: ...
def get_cost_results_for_timestamp(crac_handle: JavaHandle, result_handle: JavaHandle, timestamp: str) -> SeriesArray: ...
...
def get_instants(crac_handle: JavaHandle) -> SeriesArray: ...
def get_max_remedial_actions_usage_limits(crac_handle: JavaHandle) -> SeriesArray: ...
def get_max_tso_usage_limit(crac_handle: JavaHandle) -> SeriesArray: ...
def get_max_topological_actions_per_tso_usage_limits(crac_handle: JavaHandle) -> SeriesArray: ...
def get_max_pst_actions_per_tso_usage_limits(crac_handle: JavaHandle) -> SeriesArray: ...
def get_max_remedial_actions_per_tso_usage_limits(crac_handle: JavaHandle) -> SeriesArray: ...
def get_max_elementary_actions_per_tso_usage_limits(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_contingencies(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_contingency_elements(crac_handle: JavaHandle) -> SeriesArray: ...
def get_flow_cnecs(crac_handle: JavaHandle) -> SeriesArray: ...
def get_angle_cnecs(crac_handle: JavaHandle) -> SeriesArray: ...
def get_voltage_cnecs(crac_handle: JavaHandle) -> SeriesArray: ...
def get_thresholds(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_pst_range_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_hvdc_range_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_injection_range_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_network_element_ids_and_keys(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_counter_trade_range_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_range_action_ranges(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_network_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_terminal_connection_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_pst_tap_position_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_generator_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_load_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_boundary_line_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_shunt_compensator_position_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_switch_actions(crac_handle: JavaHandle) -> SeriesArray: ...
def get_crac_switch_pairs(crac_handle: JavaHandle) -> SeriesArray: ...
def get_on_instant_usage_rules(crac_handle: JavaHandle) -> SeriesArray: ...
def get_on_contingency_state_usage_rules(crac_handle: JavaHandle) -> SeriesArray: ...
def get_on_constraint_usage_rules(crac_handle: JavaHandle) -> SeriesArray: ...
def get_on_flow_constraint_in_country_usage_rules(crac_handle: JavaHandle) -> SeriesArray: ...
...
def run_marmot(timestamps: List[str], networks: List[JavaHandle], cracs: List[JavaHandle], parameters: RaoParameters, constraints: JavaHandle) -> JavaHandle: ...
def load_time_coupled_constraints(constraints_source: memoryview) -> JavaHandle: ...
...
def run_grid2op_loadflow(backend: JavaHandle, parameters: LoadFlowParameters, report_node: Optional[JavaHandle]) -> LoadFlowComponentResultArray: ...

class ScalingType:
    __members__: ClassVar[Dict[str, ScalingType]] = ...
    DELTA_P: ClassVar[ScalingType] = ...
    TARGET_P: ClassVar[ScalingType] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
...
class Priority:
    __members__: ClassVar[Dict[str, Priority]] = ...
    RESPECT_OF_VOLUME_ASKED: ClassVar[Priority] = ...
    RESPECT_OF_DISTRIBUTION: ClassVar[Priority] = ...
    ONESHOT: ClassVar[Priority] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
...
class ScalingConvention:
    __members__: ClassVar[Dict[str, ScalingConvention]] = ...
    GENERATOR_SCALING_CONVENTION: ClassVar[ScalingConvention] = ...
    LOAD_SCALING_CONVENTION: ClassVar[ScalingConvention] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
...
class DistributionMode:
    __members__: ClassVar[Dict[str, DistributionMode]] = ...
    PROPORTIONAL_TO_TARGETP: ClassVar[DistributionMode] = ...
    PROPORTIONAL_TO_PMAX: ClassVar[DistributionMode] = ...
    PROPORTIONAL_TO_DIFF_PMAX_TARGETP: ClassVar[DistributionMode] = ...
    PROPORTIONAL_TO_DIFF_TARGETP_PMIN: ClassVar[DistributionMode] = ...
    PROPORTIONAL_TO_P0: ClassVar[DistributionMode] = ...
    UNIFORM_DISTRIBUTION: ClassVar[DistributionMode] = ...
    def __init__(self, arg0: int) -> None: ...
    def __eq__(self, arg0: object) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
