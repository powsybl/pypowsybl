...
def get_grid2op_integer_value(backend: JavaHandle, value_type: Grid2opIntegerValueType) -> numpy.ndarray: ...

def get_grid2op_double_value(backend: JavaHandle, value_type: Grid2opDoubleValueType) -> numpy.ndarray: ...

def update_grid2op_double_value(backend: JavaHandle, value_type: Grid2opUpdateDoubleValueType, value: numpy.ndarray, changed: numpy.ndarray) -> None: ...

def update_grid2op_integer_value(backend: JavaHandle, value_type: Grid2opUpdateIntegerValueType, value: numpy.ndarray, changed: numpy.ndarray) -> None: ...
