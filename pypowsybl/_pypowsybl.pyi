...
def create_grid2op_backend(_handle: JavaHandle, buses_per_voltage_level: int, connect_all_elements_to_first_bus: bool) -> JavaHandle: ...

def free_grid2op_backend(_handle: JavaHandle) -> None: ...

def get_grid2op_string_value(_handle: JavaHandle, value_type: Grid2opStringValueType) -> List[str]: ...

def get_grid2op_integer_value(_handle: JavaHandle, value_type: Grid2opIntegerValueType) -> numpy.ndarray: ...

def get_grid2op_double_value(_handle: JavaHandle, value_type: Grid2opDoubleValueType) -> numpy.ndarray: ...

def update_grid2op_double_value(_handle: JavaHandle, value_type: Grid2opUpdateDoubleValueType, value: numpy.ndarray, changed: numpy.ndarray) -> None: ...

def update_grid2op_integer_value(_handle: JavaHandle, value_type: Grid2opUpdateIntegerValueType, value: numpy.ndarray, changed: numpy.ndarray) -> None: ...
