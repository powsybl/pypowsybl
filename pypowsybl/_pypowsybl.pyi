from typing import Any, ClassVar, Dict, Iterator, List, Sequence, Optional
...
def create_network_elements_series_array(network: JavaHandle, element_type: ElementType, filter_attributes_type: FilterAttributesType, attributes: List[str], array: Optional[ArrayStruct]) -> SeriesArray: ...
