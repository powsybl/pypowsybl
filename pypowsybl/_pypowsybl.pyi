...
def create_network_modification(network: JavaHandle, dataframe: Optional[Dataframe], switch_kind: List[str], network_modification_type: NetworkModificationType, raise_exception: Optional[bool], reporter: Optional[JavaHandle]) -> None: ...