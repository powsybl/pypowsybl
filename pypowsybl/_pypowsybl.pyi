...
def create_scalable(type: int, injection_id: str, min_value: float, max_value: float, children: List[JavaHandle]) -> JavaHandle: ...
def scale(network: JavaHandle, scalable: JavaHandle, scaling_parameters: ScalingParameters, asked: float) -> float: ... #TODO parameters
