...
def attach_new_line_on_line(network: JavaHandle, voltage_level_id: str, bbs_or_bus_id: str, line_id: str, percent: float, df_new_line: Dataframe) -> None: ...
def attach_voltage_level_on_line(network: JavaHandle, voltage_level_id: str, bbs_or_bus_id: str, line_id: str, percent: float) -> None: ...
