...
def get_series_metadata(element_type: ElementType) -> List[SeriesMetadata]: ...
...
def update_network_elements_with_series(network: JavaHandle, array: ArrayStruct, element_type: ElementType) -> None: ...
