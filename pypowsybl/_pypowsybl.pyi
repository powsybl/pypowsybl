...
def run_sensitivity_analysis_adjoint(sensitivity_analysis_context: JavaHandle, network: JavaHandle, cotangents: List[float], parameters: SensitivityAnalysisParameters, provider: str) -> JavaHandle: ...
def get_gradient(sensitivity_analysis_adjoint_result_context: JavaHandle, matrix_id: str) -> Matrix: ...
