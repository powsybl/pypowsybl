...
class LayoutParameters:
    ...
    nodes_infos: bool
    component_library_provider: str
    def __init__(self) -> None: ...
...
def add_event_branch_disconnection(event_mapping_handle: JavaHandle, event_model_id: str, static_id: str, event_time: float, disconnect_origin: bool, disconnect_extremity: bool) -> None: ...
def add_event_set_point_boolean(event_mapping_handle: JavaHandle, event_model_id: str, static_id: str, event_time: float, state_event: bool) -> None: ...
...
def get_single_line_diagram_component_library_provider_names() -> List[str]: ...
