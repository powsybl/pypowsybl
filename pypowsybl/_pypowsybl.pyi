...
def run_loadflow(network: JavaHandle, parameters: LoadFlowParameters, provider: str, report: JavaHandle | None) -> LoadFlowComponentResultArray: ...
def run_loadflow_async(network: JavaHandle, variant_id: str, parameters: LoadFlowParameters, provider: str, report: JavaHandle | None, results_future: Any) -> None: ...
...
def run_security_analysis(security_analysis_context: JavaHandle, network: JavaHandle, parameters: SecurityAnalysisParameters, provider: str, report: JavaHandle | None) -> JavaHandle: ...
def run_sensitivity_analysis(sensitivity_analysis_context: JavaHandle, network: JavaHandle, parameters: SensitivityAnalysisParameters, provider: str, report: JavaHandle | None) -> JavaHandle: ...
...
def run_grid2op_loadflow(backend: JavaHandle, parameters: LoadFlowParameters, report_node: JavaHandle | None) -> LoadFlowComponentResultArray: ...
