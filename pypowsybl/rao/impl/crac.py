...
class Crac:
    ...
    """
    def get_crac_instants(self) -> DataFrame:
    ...
    """
    def get_max_remedial_actions_usage_limit(self) -> DataFrame:
    ...
    """
    def get_max_topological_action_per_tso_usage_limit(self) -> DataFrame:
    ...
    """
    def get_max_pst_action_per_tso_usage_limit(self) -> DataFrame:
    ...
    """
    def get_max_remedial_action_per_tso_usage_limit(self) -> DataFrame:
    ...
    """
    def get_max_elementary_action_per_tso_usage_limit(self) -> DataFrame:
    ...
    """
    def get_crac_contingencies(self) -> DataFrame:
    ...
    """
    def get_crac_contingency_elements(self) -> DataFrame:
    ...
    """
    def get_crac_flow_cnecs(self) -> DataFrame:
    ...
    """
    def get_crac_angle_cnecs(self) -> DataFrame:
    ...
    """
    def get_crac_voltage_cnecs(self) -> DataFrame:
    ...
    """
    def get_crac_thresholds(self) -> DataFrame:
    ...
    """
    def get_crac_pst_range_actions(self) -> DataFrame:
    ...
    """
    def get_crac_hvdc_range_actions(self) -> DataFrame:
    ...
    """
    def get_crac_injection_range_actions(self) -> DataFrame:
    ...
    """
    def get_crac_injection_ra_elements(self) -> DataFrame:
    ...
    """
    def get_crac_counter_trade_range_actions(self) -> DataFrame:
    ...
    """
    def get_crac_range_action_ranges(self) -> DataFrame:
    ...
    """
    def get_crac_network_actions(self) -> DataFrame:
    ...
    """
    def get_dangling_line_actions(self) -> DataFrame:
    ...
    """
    def get_switch_pairs_action(self) -> DataFrame:
    ...
    """
    def get_on_instant_usage_rule(self) -> DataFrame:
    ...
    """
    def get_on_contingency_state_usage_rule(self) -> DataFrame:
    ...
    """
    def get_on_constraint_usage_rule(self) -> DataFrame:
    ...
    """
    def get_on_flow_constraint_in_country_usage_rule(self) -> DataFrame:
