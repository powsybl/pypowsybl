...
from pypowsybl._pypowsybl import PstModel, RaoParameters, RaRangeShrinking, Solver


class RangeActionOptimizationParameters:
    def __init__(
        self,
        max_mip_iterations: Optional[int] = None,
    ...
    def _init_from_c(self, c_parameters: RaoParameters) -> None:
        ...
        self.injection_ra_min_impact_threshold = (
        ...
        self.injection_ra_sensitivity_threshold = (
