...
class NotOptimizedCnecsParameters:
    def __init__(
        self,
        do_not_optimize_curative_cnecs_for_tsos_without_cras: Optional[bool] = None,
        ...
        if do_not_optimize_curative_cnecs_for_tsos_without_cras is not None:
            self.do_not_optimize_curative_cnecs_for_tsos_without_cras = (
                do_not_optimize_curative_cnecs_for_tsos_without_cras
            )
