...
class LoadFlowAndSensitivityParameters:
    def __init__(self, load_flow_provider:  str | None = None,
                 sensitivity_provider:  str | None = None,
                 sensitivity_parameters: SensitivityParameters | None = None,
                 sensitivity_failure_overcost: float | None = None,
