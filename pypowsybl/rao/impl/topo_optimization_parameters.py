...
class TopoOptimizationParameters:
    def __init__(
        self,
        max_preventive_search_tree_depth: Optional[int] = None,
    ...
    def _init_from_c(self, c_parameters: RaoParameters) -> None:
        self.max_preventive_search_tree_depth = (
            c_parameters.max_preventive_search_tree_depth
        )
        self.max_curative_search_tree_depth = (
