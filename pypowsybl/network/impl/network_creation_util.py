...
def _create_network(
    name: str, network_id: str = "", allow_variant_multi_thread_access: bool = False
) -> Network:
    return Network(
        _pp.create_network(name, network_id, allow_variant_multi_thread_access)
    )


def create_empty(
    network_id: str = "Default", allow_variant_multi_thread_access: bool = False
) -> Network:
    """
...
def create_eurostag_tutorial_example1_network(
    ...
    return _create_network(
        "eurostag_tutorial_example1", "", allow_variant_multi_thread_access
    )
...
def create_eurostag_tutorial_example1_with_more_generators_network(
    ...
    """
    return _create_network(
        "eurostag_tutorial_example1_with_more_generators",
        "",
...
def create_four_substations_node_breaker_network(
    ...
    """
    return _create_network(
        "four_substations_node_breaker", "", allow_variant_multi_thread_access
    )
...
def create_micro_grid_be_network(
    allow_variant_multi_thread_access: bool = False,
) -> Network:
    """
...
def create_micro_grid_nl_network(
    allow_variant_multi_thread_access: bool = False,
) -> Network:
    """
...
def create_metrix_tutorial_six_buses_network(
    allow_variant_multi_thread_access: bool = False,
) -> Network:
    """
    ...
    """
    return _create_network(
        "metrix_tutorial_six_buses", "", allow_variant_multi_thread_access
    )
...
def load_from_binary_buffer(
    ...
    if reporter is not None:
        warnings.warn(DEPRECATED_REPORTER_WARNING, DeprecationWarning)
        report_node = reporter
    return load_from_binary_buffers(
        [buffer],
        {} if parameters is None else parameters,
        [] if post_processors is None else post_processors,
        None,
...
def load_from_binary_buffers(
    ...
    return Network(
        _pp.load_network_from_binary_buffers(
            buffer_list,
            {} if parameters is None else parameters,
            [] if post_processors is None else post_processors,
            (
