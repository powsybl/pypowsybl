...
class NadProfile:
    ...
    def __init__(
        self,
        branch_labels: Optional[DataFrame] = None,
        three_wt_labels: Optional[DataFrame] = None,
        injections_labels: Optional[DataFrame] = None,
        bus_descriptions: Optional[DataFrame] = None,
        vl_descriptions: Optional[DataFrame] = None,
        bus_node_styles: Optional[DataFrame] = None,
        edge_styles: Optional[DataFrame] = None,
    ...
    def _create_nad_branch_labels_c_dataframe(self) -> Optional[_pp.Dataframe]:
        return (
            ...
            else _create_c_dataframe(
                self._branch_labels.fillna(""), NadProfile._nad_branch_labels_metadata
            )
        )
    ...
    def _create_nad_three_wt_labels_c_dataframe(self) -> Optional[_pp.Dataframe]:
        return (
            None
            if self._three_wt_labels is None
            else _create_c_dataframe(
                self._three_wt_labels.fillna(""), NadProfile._nad_three_wt_metadata
            )
        )
    ...
    def _create_nad_injections_labels_c_dataframe(self) -> Optional[_pp.Dataframe]:
        return (
            None
            if self._injections_labels is None
            else _create_c_dataframe(
                self._injections_labels.fillna(""), NadProfile._nad_injections_metadata
            )
        )
    ...
    def _create_nad_bus_descriptions_c_dataframe(self) -> Optional[_pp.Dataframe]:
        return (
            None
            if self._bus_descriptions is None
            else _create_c_dataframe(
                self._bus_descriptions.fillna(""),
    ...
    def _create_nad_vl_descriptions_c_dataframe(self) -> Optional[_pp.Dataframe]:
        return (
            None
            if self._vl_descriptions is None
            else _create_c_dataframe(
                self._vl_descriptions.fillna(""), NadProfile._nad_descriptions_metadata
            )
        )
    ...
    def _create_nad_bus_node_styles_c_dataframe(self) -> Optional[_pp.Dataframe]:
        return (
            None
            if self._bus_node_styles is None
            else _create_c_dataframe(
                self._bus_node_styles.fillna(""),
    ...
    def _create_nad_edge_styles_c_dataframe(self) -> Optional[_pp.Dataframe]:
        return (
            None
            if self._edge_styles is None
            else _create_c_dataframe(
                self._edge_styles.fillna(""), NadProfile._nad_edge_styles_metadata
            )
        )
    ...
    def _create_nad_three_wt_styles_c_dataframe(self) -> Optional[_pp.Dataframe]:
        return (
            None
            if self._three_wt_styles is None
            else _create_c_dataframe(
                self._three_wt_styles.fillna(""),
