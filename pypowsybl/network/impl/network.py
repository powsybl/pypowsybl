...
from .nad_customizer import NadCustomizer
from .svg import Svg
...
class Network:  # pylint: disable=too-many-public-methods
    ...
    def write_network_area_diagram(self, svg_file: PathOrStr, voltage_level_ids: Union[str, List[str]] = None,
                                   ...
                                   nad_customizer: NadCustomizer = None) -> None:
        """
        Create a network area diagram in SVG format and write it to a file.
        ...
        Args:
            ...
            nad_customizer: parameters to customize the network area diagram
        """
        svg_file = path_to_str(svg_file)
        ...
        _pp.write_network_area_diagram_svg(self._handle, svg_file, '' if metadata_file is None else path_to_str(metadata_file),
                                           ...
                                           None if nad_customizer is None else nad_customizer._create_nad_three_wt_labels_c_dataframe(), # pylint: disable=protected-access
                                           None if nad_customizer is None else nad_customizer._create_nad_bus_descriptions_c_dataframe(), # pylint: disable=protected-access
                                           None if nad_customizer is None else nad_customizer._create_nad_vl_descriptions_c_dataframe()) # pylint: disable=protected-access
    ...
    def get_network_area_diagram(self, voltage_level_ids: Union[str, List[str]] = None, depth: int = 0,
                                 ...
                                 nad_customizer: NadCustomizer = None) -> Svg:
        """
