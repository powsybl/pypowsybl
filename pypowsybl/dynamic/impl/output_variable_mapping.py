...
class OutputVariableMapping:
    ...
    def add_curves(self, model_id: str, variables: list[str] | str) -> None:
        """
    ...
    def add_dynamic_model_curves(self, dynamic_model_id: str, variables: list[str] | str) -> None:
        """
        .. deprecated:: 1.15.0
    ...
    def add_standard_model_curves(self, static_id: str, variables: list[str] | str) -> None:
        """
        .. deprecated:: 1.15.0
            Use :func:`add_curves` instead.
        """
    ...
    def add_final_state_values(self, model_id: str, variables: list[str] | str) -> None:
        """
    ...
    def add_dynamic_model_final_state_values(self, dynamic_model_id: str, variables: list[str] | str) -> None:
        """
        .. deprecated:: 1.15.0
    ...
    def add_standard_model_final_state_values(self, static_id: str, variables: list[str] | str) -> None:
        """
        .. deprecated:: 1.15.0
            Use :func:`add_final_state_values` instead.
        """
