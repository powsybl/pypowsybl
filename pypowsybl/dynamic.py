...
class ModelMapping:
    ...
    def add_alphabeta_load(self, static_id: str, parameter_set_id: str):
        _pp.add_alphabeta_load(self._handle, static_id, parameter_set_id)

    def add_one_transformer_load(self, static_id: str, dynamic_param: str):
        _pp.add_one_transformer_load(self._handle, static_id, dynamic_param)

    def add_omega_ref(self, generatorId: str):
        _pp.add_omega_ref(self._handle, generatorId)

    def add_generator_synchronous_three_windings(self, static_id: str, dynamic_param: str):
        _pp.add_generator_synchronous_three_windings(
            self._handle, static_id, dynamic_param)

    def add_generator_synchronous_three_windings_proportional_regulations(self, static_id: str, dynamic_param: str):
        _pp.add_generator_synchronous_three_windings_proportional_regulations(
            self._handle, static_id, dynamic_param)

    def add_generator_synchronous_four_windings(self, static_id: str, dynamic_param: str):
        _pp.add_generator_synchronous_four_windings(
            self._handle, static_id, dynamic_param)

    def add_generator_synchronous_four_windings_proportional_regulations(self, static_id: str, dynamic_param: str):
        _pp.add_generator_synchronous_four_windings_proportional_regulations(
            self._handle, static_id, dynamic_param)

    def add_current_limit_automaton(self, static_id: str, dynamic_param: str, branch_side: BranchSide):
...
class CurveMapping:
    ...
    def add_curve(self, dynamic_id: str, variable: str):
...
class EventMapping:
    ...
    def add_quadripole_disconnection(self, event_model_id: str, static_id: str, parameter_set_id: str):
        _pp.add_event_quadripole_disconnection(
            self._handle, event_model_id, static_id, parameter_set_id)

    def add_set_point_boolean(self, event_model_id: str, static_id: str, parameter_set_id: str):
...
class Simulation:
    ...
    def set_config(self, path, config_name):
