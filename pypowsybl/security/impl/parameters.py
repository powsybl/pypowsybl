...
class Parameters:  # pylint: disable=too-few-public-methods
    ...
    def _init_with_default_values(self) -> None:
        ...
        self._increased_violations = IncreasedViolationsParameters(
            default_parameters.flow_proportional_threshold,
    ...
    def _to_c_parameters(self) -> _pypowsybl.SecurityAnalysisParameters:
        ...
        c_parameters.flow_proportional_threshold = (
            self.increased_violations.flow_proportional_threshold
        )
        c_parameters.low_voltage_proportional_threshold = (
            self.increased_violations.low_voltage_proportional_threshold
        )
        c_parameters.low_voltage_absolute_threshold = (
            self.increased_violations.low_voltage_absolute_threshold
        )
        c_parameters.high_voltage_proportional_threshold = (
            self.increased_violations.high_voltage_proportional_threshold
        )
        c_parameters.high_voltage_absolute_threshold = (
            self.increased_violations.high_voltage_absolute_threshold
        )
