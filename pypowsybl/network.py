...
class Network(object):
    ...
    def get_elements(self, element_type: _pypowsybl.ElementType, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index=None) -> _DataFrame:
        """
        ...
        if sel_index is not None:
            ...
            for idx, index_name in enumerate(sel_index.names):
                ...
                if is_multi_index:
                    columns_values.append(sel_index.get_level_values(index_name))
                else:
                    columns_values.append(sel_index.values)
                columns_names.append(index_name)
                columns_types.append(metadata_by_name[index_name].type)
                is_index.append(False)
            sel_index_array = _pypowsybl.create_dataframe(columns_values, columns_names, columns_types, is_index)
        else:
            sel_index_array = _pypowsybl.create_dataframe([[]], [''], [1], [False])

        series_array = _pypowsybl.create_network_elements_series_array(self._handle, element_type, filter_attributes, attributes, sel_index_array)
        return _create_data_frame_from_series_array(series_array)

    def get_buses(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ======= ======== ======= ================
        """
        return self.get_elements(_pypowsybl.ElementType.BUS, all_attributes, attributes, sel_index)

    def get_generators(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        .. warning::
            ...
            should hold.
        """
        return self.get_elements(_pypowsybl.ElementType.GENERATOR, all_attributes, attributes, sel_index)

    def get_loads(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ===== ========== === === ================ ======= =========
        """
        return self.get_elements(_pypowsybl.ElementType.LOAD, all_attributes, attributes, sel_index)

    def get_batteries(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        """
        return self.get_elements(_pypowsybl.ElementType.BATTERY, all_attributes, attributes, sel_index)

    def get_lines(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ======== === === === === === === ================= ================= ======= ======= ========== ==========
        """
        return self.get_elements(_pypowsybl.ElementType.LINE, all_attributes, attributes, sel_index)

    def get_2_windings_transformers(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ====== === === === === === === ================= ================= ======= ======= ========== ==========
        """
        return self.get_elements(_pypowsybl.ElementType.TWO_WINDINGS_TRANSFORMER, all_attributes, attributes, sel_index)

    def get_3_windings_transformers(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        """
        return self.get_elements(_pypowsybl.ElementType.THREE_WINDINGS_TRANSFORMER, all_attributes, attributes, sel_index)

    def get_shunt_compensators(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ===== ========== === === === ================ ====== =========
        """
        return self.get_elements(_pypowsybl.ElementType.SHUNT_COMPENSATOR, all_attributes, attributes, sel_index)

    def get_non_linear_shunt_compensator_sections(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        """
        return self.get_elements(_pypowsybl.ElementType.NON_LINEAR_SHUNT_COMPENSATOR_SECTION, all_attributes, attributes, sel_index)

    def get_linear_shunt_compensator_sections(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        """
        return self.get_elements(_pypowsybl.ElementType.LINEAR_SHUNT_COMPENSATOR_SECTION, all_attributes, attributes, sel_index)

    def get_dangling_lines(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            == === === === ================ ====== =========
        """
        return self.get_elements(_pypowsybl.ElementType.DANGLING_LINE, all_attributes, attributes, sel_index)

    def get_lcc_converter_stations(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ======== ====== === === ================ ======= =========
        """
        return self.get_elements(_pypowsybl.ElementType.LCC_CONVERTER_STATION, all_attributes, attributes, sel_index)

    def get_vsc_converter_stations(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ======== ====== ========= ========== ================ ======= =========
        """
        return self.get_elements(_pypowsybl.ElementType.VSC_CONVERTER_STATION, all_attributes, attributes, sel_index)

    def get_static_var_compensators(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ======== === ======== === ================ ======= =========
        """
        return self.get_elements(_pypowsybl.ElementType.STATIC_VAR_COMPENSATOR, all_attributes, attributes, sel_index)

    def get_voltage_levels(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ========= ============= =========
        """
        return self.get_elements(_pypowsybl.ElementType.VOLTAGE_LEVEL, all_attributes, attributes, sel_index)

    def get_busbar_sections(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ========== ======== ======== ================ =========
        """
        return self.get_elements(_pypowsybl.ElementType.BUSBAR_SECTION, all_attributes, attributes, sel_index)

    def get_substations(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        """
        return self.get_elements(_pypowsybl.ElementType.SUBSTATION, all_attributes, attributes, sel_index)

    def get_hvdc_lines(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ===== ================================ ===================== ========= ===================== ===================== ========== ==========
        """
        return self.get_elements(_pypowsybl.ElementType.HVDC_LINE, all_attributes, attributes, sel_index)

    def get_switches(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ============================ ============ ====== ================
        """
        return self.get_elements(_pypowsybl.ElementType.SWITCH, all_attributes, attributes, sel_index)

    def get_ratio_tap_changer_steps(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ========== ======== ======== === ===
        """
        return self.get_elements(_pypowsybl.ElementType.RATIO_TAP_CHANGER_STEP, all_attributes, attributes, sel_index)

    def get_phase_tap_changer_steps(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            === ======== ==== ========= =========
        """
        return self.get_elements(_pypowsybl.ElementType.PHASE_TAP_CHANGER_STEP, all_attributes, attributes, sel_index)

    def get_ratio_tap_changers(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            ========== === ======= ======== ========== ======== =================
        """
        return self.get_elements(_pypowsybl.ElementType.RATIO_TAP_CHANGER, all_attributes, attributes, sel_index)

    def get_phase_tap_changers(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        Examples:
            ...
            === === ======= ======== ========== =================
        """
        return self.get_elements(_pypowsybl.ElementType.PHASE_TAP_CHANGER, all_attributes, attributes, sel_index)

    def get_reactive_capability_curve_points(self, all_attributes: bool = False, attributes: _List[str] = [], sel_index: _pd.Index = None) -> _DataFrame:
        """
        ...
        """
        return self.get_elements(_pypowsybl.ElementType.REACTIVE_CAPABILITY_CURVE_POINT, all_attributes, attributes, sel_index)
