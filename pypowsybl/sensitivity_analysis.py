...
class SensitivityAnalysisResult(ObjectHandle):
    ...
    def get_branch_flows_sensitivity_matrix(self):
        ...
        :return: the matrix of sensitivities on N situation
        :rtype: _pypowsybl.Matrix
        """
    ...
    def get_post_contingency_branch_flows_sensitivity_matrix(self, contingency_id: str):
        ...
        :param contingency_id: ID of the contingency
        :type contingency_id: str
        :return: the matrix of sensitivities for the specified contingency
    ...
    def get_post_contingency_reference_flows(self, contingency_id: str):
        ...
        :param contingency_id: ID of the contingency
        :type contingency_id: str
        :return: the values of branch flows after the specified contingency
        :rtype: pandas.DataFrame
        """
    ...
    def get_post_contingency_reference_voltages(self, contingency_id: str):
        ...
        :param contingency_id: ID of the contingency
        :type contingency_id: str
        :return: the values of bus voltages after the specified contingency
        :rtype: pandas.DataFrame
        """
...
class SensitivityAnalysis(ContingencyContainer):
    ...
    def set_branch_flow_factor_matrix(self, branches_ids: List[str], injections_or_transformers_ids: List[str]):
        ...
        :param branches_ids: IDs of branches for which active power flow sensitivities should be computed
        :type branches_ids: list
        :param injections_or_transformers_ids: IDs of injections or PSTs which may impact branch flows,
                                               to which we should compute sensitivities
        :type injections_or_transformers_ids: list
        """
    ...
    def set_bus_voltage_factor_matrix(self, bus_ids: List[str], target_voltage_ids: List[str]):
        ...
        :param bus_ids: IDs of buses for which voltage sensitivities should be computed
        :type bus_ids: list
        :param target_voltage_ids: IDs of regulating equipments to which we should compute sensitivities
        :type target_voltage_ids: list
        """
    ...
    def run_dc(self, network: Network, parameters: Parameters = Parameters(), provider = 'OpenSensitivityAnalysis') -> SensitivityAnalysisResult:
        ...
        :param network: Network on which the sensitivities will be computed
        :type network: Network
        :param parameters: Sensitivity analysis parameters
        :type parameters: Parameters, optional
        :param provider: Name of the sensitivity analysis implementation to be used
        :type provider: str, optional
        :return: a sensitivity analysis result
        """
    ...
    def run_ac(self, network: Network, parameters: Parameters = Parameters(), provider = 'OpenSensitivityAnalysis') -> SensitivityAnalysisResult:
...
def create() -> SensitivityAnalysis:
    ...
    :return: a new sensitivity analysis
    """
