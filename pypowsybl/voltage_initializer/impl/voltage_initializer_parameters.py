...
class VoltageInitializerParameters:
    ...
    def add_variable_two_windings_transformers(
        self, transformer_id_list: List[str]
    ) -> None:
        """
    ...
    def add_specific_low_voltage_limits(
        self, low_limits: List[Tuple[str, bool, float]]
    ) -> None:
        """
        ...
        for voltage_level_id, is_relative, limit in low_limits:
            voltage_initializer_add_specific_low_voltage_limits(
                self._handle, voltage_level_id, is_relative, limit
            )

    def add_specific_high_voltage_limits(
        self, high_limits: List[Tuple[str, bool, float]]
    ) -> None:
        """
    ...
    def add_specific_voltage_limits(
    ...
    def set_log_level_ampl(
        self, log_level_ampl: VoltageInitializerLogLevelAmpl
    ) -> None:
        """
    ...
    def set_log_level_solver(
        self, log_level_solver: VoltageInitializerLogLevelSolver
    ) -> None:
        """
    ...
    def set_reactive_slack_buses_mode(
        self, reactive_slack_buses_mode: VoltageInitializerReactiveSlackBusesMode
    ) -> None:
        """
        Changes the log level of non-linear optimization solver printings.
        ...
        """
        voltage_initializer_set_reactive_slack_buses_mode(
            self._handle, reactive_slack_buses_mode
        )

    def set_min_plausible_low_voltage_limit(
        self, min_plausible_low_voltage_level: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_min_plausible_low_voltage_limit(
            self._handle, min_plausible_low_voltage_level
        )

    def set_max_plausible_high_voltage_limit(
        self, max_plausible_high_voltage_limit: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_max_plausible_high_voltage_limit(
            self._handle, max_plausible_high_voltage_limit
        )

    def set_active_power_variation_rate(
        self, active_power_variation_rate: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_active_power_variation_rate(
            self._handle, active_power_variation_rate
        )

    def set_min_plausible_active_power_threshold(
        self, min_plausible_active_power_threshold: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_min_plausible_active_power_threshold(
            self._handle, min_plausible_active_power_threshold
        )
    ...
    def set_low_impedance_threshold(self, low_impedance_threshold: float) -> None:
        ...
        """
        voltage_initializer_set_low_impedance_threshold(
            self._handle, low_impedance_threshold
        )

    def set_min_nominal_voltage_ignored_bus(
        self, min_nominal_voltage_ignored_bus: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_min_nominal_voltage_ignored_bus(
            self._handle, min_nominal_voltage_ignored_bus
        )

    def set_min_nominal_voltage_ignored_voltage_bounds(
        self, min_nominal_voltage_ignored_voltage_bounds: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_min_nominal_voltage_ignored_voltage_bounds(
            self._handle, min_nominal_voltage_ignored_voltage_bounds
        )
    ...
    def set_max_plausible_power_limit(self, max_plausible_power_limit: float) -> None:
        ...
        """
        voltage_initializer_set_max_plausible_power_limit(
            self._handle, max_plausible_power_limit
        )

    def set_high_active_power_default_limit(
        self, high_active_power_default_limit: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_high_active_power_default_limit(
            self._handle, high_active_power_default_limit
        )

    def set_low_active_power_default_limit(
        self, low_active_power_default_limit: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_low_active_power_default_limit(
            self._handle, low_active_power_default_limit
        )
    ...
    def set_default_minimal_qp_range(self, default_minimal_qp_range: float) -> None:
        ...
        """
        voltage_initializer_set_default_minimal_qp_range(
            self._handle, default_minimal_qp_range
        )
    ...
    def set_default_qmax_pmax_ratio(self, default_qmax_pmax_ratio: float) -> None:
        ...
        """
        voltage_initializer_set_default_qmax_pmax_ratio(
            self._handle, default_qmax_pmax_ratio
        )

    def set_default_variable_scaling_factor(
        self, default_variable_scaling_factor: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_default_variable_scaling_factor(
            self._handle, default_variable_scaling_factor
        )

    def set_default_constraint_scaling_factor(
        self, default_constraint_scaling_factor: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_default_constraint_scaling_factor(
            self._handle, default_constraint_scaling_factor
        )

    def set_reactive_slack_variable_scaling_factor(
        self, reactive_slack_variable_scaling_factor: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_reactive_slack_variable_scaling_factor(
            self._handle, reactive_slack_variable_scaling_factor
        )

    def set_twt_ratio_variable_scaling_factor(
        self, twt_ratio_variable_scaling_factor: float
    ) -> None:
        """
        ...
        """
        voltage_initializer_set_twt_ratio_variable_scaling_factor(
            self._handle, twt_ratio_variable_scaling_factor
        )
