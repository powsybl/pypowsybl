...
.. doctest::
    ...
    >>> network.get_generators() # doctest: +NORMALIZE_WHITESPACE
         name energy_source  target_p    min_p   max_p          min_q          max_q  target_v  target_q  voltage_regulator_on regulating_terminal   p   q   i voltage_level_id   bus_id  connected
    id
