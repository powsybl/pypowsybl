...
PYBIND11_MODULE(_pypowsybl, m) {
    ...
    m.def("revert_create_line_on_line", &pypowsybl::revertCreateLineOnLine, "reverses the action done in the create_line_on_line", py::arg("network"), py::arg("lineToBeMerged1Id"), py::arg("lineToBeMerged2Id"), py::arg("lineToBeDeletedId"), py::arg("mergedLineId"), py::arg("mergedLineName"));
    ...
    m.def("revert_connect_voltage_level_on_line", &pypowsybl::revertConnectVoltageLevelOnLine, "reverses the action done in connect_voltage_level_on_line", py::arg("network"), py::arg("line1Id"), py::arg("line2Id"), py::arg("lineId"), py::arg("lineName"));
