...
PYBIND11_MODULE(_pypowsybl, m) {
    ...
    m.def("get_network_area_diagram_displayed_voltageLevels", &pypowsybl::getNetworkAreaDiagramDisplayedVoltageLevels, "Get network area diagram displayed voltage level",
