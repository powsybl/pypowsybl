...
PYBIND11_MODULE(_pypowsybl, m) {
    ...
    m.def("load_cgmes_network_from_binary_buffers", &pypowsybl::loadCgmesNetworkFromBinaryBuffers, "Load a network from a binary buffer", py::call_guard<py::gil_scoped_release>(),
