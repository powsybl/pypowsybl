...
PYBIND11_MODULE(_pypowsybl, m) {
    ...
    m.def("get_flow_cnec_results", &pypowsybl::getFlowCnecResults, "Get flow cnec results", py::arg("crac"), py::arg("rao_result"));
    m.def("get_angle_cnec_results", &pypowsybl::getAngleCnecResults, "Get angle cnec results", py::arg("crac"), py::arg("rao_result"));
    m.def("get_voltage_cnec_results", &pypowsybl::getVoltageCnecResults, "Get voltage cnec results", py::arg("crac"), py::arg("rao_result"));
    m.def("get_ra_results", &pypowsybl::getRaResults, "Get ra results", py::arg("crac"), py::arg("rao_result"));
