...
PYBIND11_MODULE(_pypowsybl, m) {
    ...
    m.def("replace_3_windings_transformers_with_3_2_windings_transformers", &pypowsybl::replace3WTWithThree2WT, "Replace 3-windings transformers with 3 2-windings transformers",
          py::arg("network"), py::arg("transformer_ids"), py::arg("reverse"), py::arg("report_node"));
