...
int scaleProportional(pypowsybl::JavaHandle network, int asked, distribution_mode distributionMode, const std::vector<std::string>& injections_ids, const int limit_min, const int limit_max, const scaling_parameters scalingParameters);
